...
(() => {
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      .hn-family-profile-top{position:relative;height:190px;margin:0 -1px;overflow:visible;background:rgba(0,0,0,.32);border:1px solid rgba(229,189,98,.22);border-radius:14px 14px 0 0}
  ...
  function wire(){
    ...
    if(!family||family.dataset.hnProfileBound==='1')return false;
  ...
  window.addEventListener('hn-family-ready',wire);
